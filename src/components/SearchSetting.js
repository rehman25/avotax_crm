        ...
        <div className='mainSearchBarSettingBox'>
            <div className="searchSettingInnerCheckBox">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="Branch_Number">Branch Number</label>
                </div>
                <div class="form-check">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="Early_Drop_off">Early Drop off</label>
                </div>
                <div class="form-check">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="Last_Drop_off">Last Drop off</label>
                </div>
            </div>
